...
11. [ ] ¿Los tres dials (densidad/audacia/movimiento) están declarados en el ScreenBrief, son coherentes con `design-tokens.md`/`discovery.md`, y son LOS MISMOS que el resto del lote (o el cambio está justificado por escrito)? ¿La audacia cae dentro del rango del registro de la pantalla (`producto` 1-3 / `marketing` 3-5), y si hay dirección creativa elegida en `brand-brief.md`, la Capa 3 la respeta?
