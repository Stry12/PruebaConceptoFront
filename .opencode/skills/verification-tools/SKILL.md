...
| `frontend_audit` | `all` | Las anteriores (css, routes, handlers, implied, tokens, registry, layers) + resumen PASS/FAIL | `qa_verifier` como primer paso; `orchestrator` para conocer el estado real |
